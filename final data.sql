INSERT INTO billingaddress_t (BillingAddressID, CustomerStreet, CustomerCity, CustomerState, CustomerZipCode, id) VALUES
...
INSERT INTO product_t (ProductID, ProductDescription, ProductPrice, ProductAvailableQuantity, ProductSKUCode, ProductImageFileName, CategoryID, ColorID, SizeID) VALUES
(1, 'High-waisted mini skirt with elastic waistband.', 50.25, 15, 123456, 'Image01.jpg', 1, 2, 2),
(2, 'Mid-rise pants with side pockets and back false welt pockets. Front zip, metal hook, and interior button closure.', 45.90, 15, 159753, 'Image02.jpg', 4, 2, 3),
(3, 'Petite recycled lace trim long sleeve mini dress', 20.20, 15, 165412, 'Image03.jpg', 3, 2, 4),
(4, 'Strap detail slip dress', 74.00, 15, 147258, 'Image04.jpg', 3, 4, 2),
(5, 'Full cut round neck sleeveless top', 85.89, 15, 258369, 'Image05.jpg', 2, 6, 3);
