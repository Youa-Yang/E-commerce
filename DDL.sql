...
CONSTRAINT CategoryID_FK2 FOREIGN KEY (SizeID)REFERENCES Size_T(Size_ID))
CONSTRAINT CategoryID_FK3 FOREIGN KEY (ColorID)REFERENCES Color_T(ColorID));
...
CREATE TABLE Size_T
(CategoryID NUMERIC(2) NOT NULL,
CategoryType VARCHAR(20) NOT NU
